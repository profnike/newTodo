...
icon.addEventListener("click",changes)
    ...
    function addlist(index){
       ...
       for(let i=0; i<elements.length; i++){
           ...
           let arrbutn=[]
           //arrbutn.push(document.querySelector(".addbutns "))
       //arrbutn.push(document.querySelectorAll(".addbutns"));
       console.log(document.querySelector(".list").childNodes.length )
      // console.log(document.querySelector(".list").childNodes.nextSibling.nextSibling)
     // arrbutn.push(document.querySelector(".list").childNodes)
      //document.querySelector(".addbutns ")[i].style.backgroundColor="yellow"
      arrbutn[i]=document.querySelectorAll(".addbutns")[i]
      console.log(arrbutn)
      console.log(document.querySelectorAll(".addbutns"))
      
   }
   //if(document.querySelectorAll(".addbutns")[index].includes){
    
  //document.querySelectorAll(".addbutns")[index].style.backgroundColor="red"; 
//}
//if(document.querySelectorAll(".addbutns")[index].style.backgroundColor="purple"){
    
   // document.querySelectorAll(".addbutns")[index].style.backgroundColor="blue"; 
  //}


   //document.querySelectorAll(".addbutns")[0].style.backgroundColor="red";
   //if(toggle===false){
    //alert( 'hi')
    //document.querySelectorAll(".addbutns")[index ].style.backgroundColor="red";
   //} 
   //else{ //document.querySelectorAll(".addbutns")[index].style.backgroundColor="yellow";}
   //toggle=!toggle   
   console.log(document.querySelectorAll(".addbutns")[1])
   ...
   //}
    ...
    function strike(index){
        ...
        if(elements[index].includes("<strike>")){
           ...
           //document.querySelector(".list").childNodes[0].style.backgroundColor="red"
           document.querySelectorAll(".addbutns")[0].style.backgroundColor="red"; 
            ...
            //if(document.querySelectorAll(".addbutns")[1].style.backgroundColor="purple"){
              //  document.querySelectorAll(".addbutns")[1].style.backgroundColor="red";
              // }
    ...
    function Colod(index){
        //document.querySelectorAll(".addbutns")[0].style.backgroundColor="red";
        
        //let allbutn=document.querySelectorAll(".addbutns")
        //let arrb=[]
        //arrb.push(allbutn)
        //console.log(arrb)
        console.log(document.querySelector(".list").children[index].style.backgroundColor)
        let lend=document.querySelector(".list").childNodes.length 
   for(let i=0; i<lend; i++){
        if(document.querySelector(".list").children[index].style.backgroundColor===""){
            alert('hi')
        //console.log(lend)
        document.querySelector(".list").children[index].style.backgroundColor="red" 
        console.log(document.querySelector(".list").children[index])}
        else{document.querySelector(".list").children[index].style.backgroundColor="green"}
       // console.log(allbutn[i])
       // allbutn[i].classList.add("butc");
    //}
    }}
    //to show all tasks
    function alltasks(){
